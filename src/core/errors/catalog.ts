...
export const ErrorCodes = {
  ...
  TWO_FA_EXPIRED: 704,
  PASSKEY_NOT_FOUND: 705,
  PASSKEY_VERIFICATION_FAILED: 706,
...
export const ErrorMessages: Record<number, ErrorDetail> = {
...
export function getErrorByCode(errorCode: number, customData: Record<string, unknown> = {}): { errorCode: number } & ErrorDetail & Record<string, unknown> {
...
export function createErrorResponse(statusCode: number, errorCode: number, customData: Record<string, unknown> = {}) {
...
export function logError(context: string, errorCode: number, additionalInfo: Record<string, unknown> = {}): void {
