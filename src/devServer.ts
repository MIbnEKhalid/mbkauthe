...
app.listen(port, () => {
  ...
  console.log(`Info page:        http://localhost:${port}/mbkauthe/info`);
  ...
  console.log(`Dev 2FA preview:  http://localhost:${port}/dev/2fa`);
  console.log(`Dev CLI preview:  http://localhost:${port}/dev/device-approval`);
  console.log(`Dev 500 error:    http://localhost:${port}/dev/500`);
  console.log(`Dev 404 error:    http://localhost:${port}/dev/404`);
